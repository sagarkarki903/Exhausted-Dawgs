    ...
    <header className="sticky top-0 bg-background/80 backdrop-blur-sm z-50 shadow-md">
      ...
      {isOpen && (
        ...
        >
          ...
          <a className="block font-semibold text-gray-700 hover:text-red-900" target="_blank" rel="noopener noreferrer" href="https://www.clover.com/pay-widgets/d682cd3a-15d8-4ba1-8bfb-b0d73eeb867b">Donate</a>
